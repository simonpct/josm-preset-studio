...
// .wrangler/tmp/pages-7JP57z/functionsWorker-0.9307987137697974.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var OSM_API_BASE_DEFAULT = "https://api.openstreetmap.org";
...
__name(err, "err");
__name2(err, "err");
async function verifyOsmToken(req, env) {
...
__name(verifyOsmToken, "verifyOsmToken");
__name2(verifyOsmToken, "verifyOsmToken");
function newId() {
...
__name(newId, "newId");
__name2(newId, "newId");
var MAX_XML_BYTES = 512 * 1024;
async function loadPreset(env, id) {
...
var onRequestOptions = /* @__PURE__ */ __name2(() => new Response(null, { status: 204, headers: CORS }), "onRequestOptions");
...
var onRequestDelete = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const id = String(params.id);
  const user = await verifyOsmToken(request, env);
  if (!user) return err(401, "Invalid or missing OSM token");
  const p = await loadPreset(env, id);
...
var onRequestOptions2 = /* @__PURE__ */ __name2(() => new Response(null, { status: 204, headers: CORS2 }), "onRequestOptions");
...
var onRequestOptions3 = /* @__PURE__ */ __name2(() => new Response(null, {
  status: 204,
  headers: {
    "access-control-allow-origin": "*",
...
__name(gunzipToString, "gunzipToString");
__name2(gunzipToString, "gunzipToString");
...
var onRequestGet3 = /* @__PURE__ */ __name2(async ({ request }) => {
  ...
  if (!data) return err2(400, "missing ?data=");
  if (data.length > MAX_DATA_CHARS) return err2(413, `data too large (${data.length} chars)`);
  if (!/^[A-Za-z0-9_-]+$/.test(data)) return err2(400, "data must be base64url");
  let xml;
  try {
    const bytes = b64urlDecode(data);
    xml = await gunzipToString(bytes);
  } catch (e) {
    return err2(400, `decode failed: ${e instanceof Error ? e.message : String(e)}`);
  }
  if (!xml.includes("<presets")) {
    return err2(400, "decoded payload is not a JOSM preset XML");
  }
...
var onRequestOptions4 = /* @__PURE__ */ __name2(() => new Response(null, {
  status: 204,
  headers: {
    "access-control-allow-origin": "*",
    "access-control-allow-methods": "GET,OPTIONS",
...
// .wrangler/tmp/bundle-TgyzyS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TgyzyS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9307987137697974.js.map
